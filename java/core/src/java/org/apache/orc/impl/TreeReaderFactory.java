...
public class TreeReaderFactory {
  ...
  public static class GeometryTreeReader extends BinaryTreeReader {
    GeometryTreeReader(int columnId, Context context) throws IOException {
      super(columnId, context);
    }
  }
    ...
    switch (readerTypeCategory) {
      ...
      case DECIMAL:
        ...
        return new DecimalTreeReader(fileType.getId(), fileType.getPrecision(),
            fileType.getScale(), context);
      case Geometry:
        return new GeometryTreeReader(fileType.getId(), context);
      case STRUCT:
